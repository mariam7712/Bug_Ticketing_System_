...
namespace Bug_Ticketing_System.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("login")]
        public async Task<Results<Ok<LoginResponseDto>, UnauthorizedHttpResult>>
                Login(LoginCredentials credentials)
        {
            ...
            // Create the response DTO with the user ID and token
            var response = new LoginResponseDto(user.Id, tokenDto.Token, tokenDto.TokenExpiration);
